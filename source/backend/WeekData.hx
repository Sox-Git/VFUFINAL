...
class WeekData {
	...
	public static function reloadWeekFiles(isStoryMode:Null<Bool> = false)
	{
		...
		var sexList:Array<String> = CoolUtil.coolTextFile(Paths.getSharedPath('data/Songlist/weekList.txt'));
		for (i in 0...sexList.length) {
			for (j in 0...directories.length) {
				var fileToCheck:String = directories[j] + 'data/Songlist/' + sexList[i] + '.json';
		...
		for (i in 0...directories.length) {
			var directory:String = directories[i] + 'data/Songlist/';
